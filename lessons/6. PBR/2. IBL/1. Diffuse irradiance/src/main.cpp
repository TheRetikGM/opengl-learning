...
int main(int argc, char** argv)
{
	...
	if (!quadShader->Program || !basicShader->Program || !pbrShader->Program || !pbrShader_tex->Program || !hdrToCubemap.Program || !skyboxShader.Program || !irradianceShader.Program)
	{
	...
	unsigned int hdrTexture = load_hdr_image(TEXTURES_DIR "newport_loft.hdr", true);
